...
Graph: `redbot-media-player-homeassistant-architecture`
Scope: RedBot Media Player (Home Assistant custom integration)
...
| CQ-02 | FCQ | What is the root repository node? | Lookup `repo:redbot-media-player-homeassistant` |
